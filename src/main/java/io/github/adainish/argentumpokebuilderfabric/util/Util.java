...
public class Util
{
    public static ServerPlayer getPlayer(UUID uuid) {
        return ArgentumPokeBuilderFabric.getServer().getPlayerList().getPlayer(uuid);
    }

    public static boolean isOnline(UUID uuid)
    {
        return ArgentumPokeBuilderFabric.getServer().getPlayerList().getPlayer(uuid) != null;
    }
    ...
    {
        try {
            ArgentumPokeBuilderFabric.getServer().getCommands().getDispatcher().execute(cmd, ArgentumPokeBuilderFabric.getServer().createCommandSourceStack());
        } catch (CommandSyntaxException e) {
            ArgentumPokeBuilderFabric.getLog().error(e);
        }
    }
