...
public class TextUtil
{
    ...
    private static final MutableComponent PLUGIN_PREFIX = Component.literal(Util.formattedString(ArgentumPokeBuilderFabric.languageConfig.prefix)).setStyle(Style.EMPTY.withColor(BLUE));

    private static final MutableComponent MESSAGE_PREFIX = getPluginPrefix().append(Component.literal(ArgentumPokeBuilderFabric.languageConfig.splitter).setStyle(Style.EMPTY.withColor(ORANGE)));
