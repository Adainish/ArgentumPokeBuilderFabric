package io.github.adainish.argentumpokebuilderfabric.storage;
...
public class PlayerStorage
{
    public static void makePlayer(UUID uuid) {
        File dir = ArgentumPokeBuilderFabric.getPlayerStorageDir();
        dir.mkdirs();
    ...
    public static void savePlayer(Player player) {
        ...
        if (reader == null) {
            ArgentumPokeBuilderFabric.getLog().error("Something went wrong attempting to read the Player Data");
            return;
        }
    ...
    public static List<Player> getAllPlayers()
    {
        ...
        for (Player p:ArgentumPokeBuilderFabric.dataWrapper.playerCache.values()) {
            playerList.add(p);
    ...
    public static Player getPlayer(UUID uuid) {
        ...
        if (ArgentumPokeBuilderFabric.dataWrapper.playerCache.containsKey(uuid))
            return ArgentumPokeBuilderFabric.dataWrapper.playerCache.get(uuid);
        ...
        try {
            ...
            ArgentumPokeBuilderFabric.getLog().error("Detected non-existing player, making new player data file");
            return null;
        }
